...
for scene_id in needed_scenes:
    ...
    dir = f'./{scene_path}/{scene_id}'
    vv_im = skimage.io.imread(f'./{dir}/VV_dB.tif')
    vh_im = skimage.io.imread(f'./{dir}/VH_dB.tif')
    bathymetry_im = skimage.io.imread(f'./{dir}/bathymetry.tif')
...
for i, label in enumerate(labels):
    ...
    skimage.io.imsave('{}/{}.jpg'.format(out_path, i), crop)
