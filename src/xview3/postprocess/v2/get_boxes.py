...
def f(t):
    ...
    dir = f'./{chip_path}/{scene_id}'
    vh_im = numpy.load('{}/vh/{}_vh.npy'.format(dir, chip_index))
    vv_im = numpy.load('{}/vv/{}_vv.npy'.format(dir, chip_index))
    bathymetry = numpy.load('{}/bathymetry/{}_bathymetry.npy'.format(dir, chip_index))
    ...
    for label in cur_labels:
        out_fname = './{}{}.png'.format(out_path, label['index'])
